    ...
    return (
        <div>
            <div style={{ margin: "20px 20px 20px" }}>
                ...
                <div>
                    <h3 style={{ color: "black", fontWeight: "bold" }}>Где еще вы можете купить наши телефоны</h3>
                    <iframe width="100%" height="450px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=500&amp;hl=en&amp;q=Samsung+(Samsung)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
